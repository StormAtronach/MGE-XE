...
namespace IPC {
	...
	*/
	...
	public:
		...
		* @param withOcclusion Whether to perform occlusion culling based on the occlusion mask generated by the last call to
		*                      generateOcclusionMask.
		* @return Whether the RPC was issued successfully.
		*/
		bool getVisibleMeshesCoarse(VecId visibleSet, const ViewFrustum& viewFrustum, DWORD setFlags, VisibleSetSort sort = VisibleSetSort::None, bool withOcclusion = false);
		...
		* @return Whether the RPC was issued successfully.
		*/
		bool getVisibleMeshes(VecId visibleSet, const ViewFrustum& viewFrustum, const D3DXVECTOR4& viewSphere, DWORD setFlags, VisibleSetSort sort = VisibleSetSort::None, bool withOcclusion = false);
