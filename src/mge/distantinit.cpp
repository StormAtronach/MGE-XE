...
D3DXHANDLE DistantLand::ehNumWeights;
D3DXHANDLE DistantLand::ehBonePalette;
D3DXHANDLE DistantLand::ehMeshWorldview;
...
bool DistantLand::initShader() {
    ...
    ehMeshWorldview = effect->GetParameterByName(0, "meshWorldview");
