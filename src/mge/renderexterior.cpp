...
void DistantLand::renderDistantLandZ() {
    // Always nested inside renderDepth:land — the only caller. Timer
    // name reflects the hierarchy.
    MGE_SCOPED_TIMER("renderDepth:land:render");
    D3DXMATRIX world;
